  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-secondary to-primary">
      <div className="max-w-6xl mx-auto p-6">
        ...
        {/* Search */}
        <div className="mb-8 shadow-md rounded-md border border-secondary/60 bg-primary/80">
          <div className="p-6">
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 sm:pl-12 py-2 w-full border border-secondary rounded-md max-sm:text-sm bg-primary text-primary placeholder-tertiary"
          ...
          {users.length > 0 ? (
            ...
            !loading && input && (
              <div className="w-full text-center py-12">
                <p className="text-tertiary text-lg">No users found matching your search criteria.</p>
                <p className="text-quaternary text-sm mt-2">Try searching with different keywords.</p>
              </div>
            )
          )}
        </div>
